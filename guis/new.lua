...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/hexinova/User-Interface/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
function mainapi:CreateGUI()
	...
	discordbutton.MouseButton1Click:Connect(function()
		...
		task.spawn(function()
			tooltip.Text = 'Copied!'
			setclipboard('https://discord.gg/s4AtuPfvpM')
		end)
	end)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/hexinova/User-Interface/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
